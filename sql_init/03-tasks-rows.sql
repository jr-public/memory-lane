...
INSERT INTO tasks (id, user_id, title, description, parent_id, depth, status_id, due_date) VALUES
  (1, 1, 'Website Redesign Project', 'Complete overhaul of company website with new branding', NULL, 0, 2, '2025-05-15'),
  (2, 2, 'Mobile App Development', 'Create a cross-platform mobile application', NULL, 0, 1, '2025-06-30'),
  (3, 3, 'Marketing Campaign', 'Q2 digital marketing campaign', NULL, 0, 3, '2025-04-10'),
  (4, 4, 'Content Creation', 'Create blog posts and social media content', NULL, 0, 4, '2025-03-25');

-- Insert second-level tasks for Website Redesign (parent_id = 1)
INSERT INTO tasks (id, user_id, title, description, parent_id, depth, status_id, due_date) VALUES
  (5, 1, 'Design mockups', 'Create design mockups for all pages', 1, 1, 4, '2025-03-20'),
  (6, 2, 'Frontend development', 'Implement responsive frontend', 1, 1, 2, '2025-04-15'),
  (7, 3, 'Backend integration', 'Connect frontend to API endpoints', 1, 1, 1, '2025-05-01');

-- Insert third-level tasks for Frontend development (parent_id = 6)
INSERT INTO tasks (id, user_id, title, description, parent_id, depth, status_id, due_date) VALUES
  (8, 2, 'Header and navigation', 'Implement main navigation', 6, 2, 4, '2025-03-25'),
  (9, 1, 'Contact form', 'Create and validate contact form', 6, 2, 2, '2025-04-05'),
  (10, 4, 'Footer components', 'Implement footer with links', 6, 2, 1, '2025-04-10');

-- Insert second-level tasks for Mobile App Development (parent_id = 2)
INSERT INTO tasks (id, user_id, title, description, parent_id, depth, status_id, due_date) VALUES
  (11, 2, 'UI/UX design', 'Create app interface designs', 2, 1, 3, '2025-04-15'),
  (12, 3, 'Core functionality', 'Implement core app features', 2, 1, 1, '2025-05-30'),
  (13, 1, 'Testing and QA', 'Quality assurance and bug fixing', 2, 1, 1, '2025-06-15');

-- Insert third-level tasks for Core functionality (parent_id = 12)
INSERT INTO tasks (id, user_id, title, description, parent_id, depth, status_id, due_date) VALUES
  (14, 3, 'Authentication system', 'Implement user login/signup', 12, 2, 2, '2025-05-01'),
  (15, 4, 'Database integration', 'Connect to backend services', 12, 2, 1, '2025-05-15');

-- Insert fourth-level tasks for Authentication system (parent_id = 14)
INSERT INTO tasks (id, user_id, title, description, parent_id, depth, status_id, due_date) VALUES
  (16, 3, 'Social login integration', 'Add Google and Facebook login', 14, 3, 1, '2025-04-25'),
  (17, 2, 'Password recovery', 'Implement password reset flow', 14, 3, 1, '2025-04-28');

-- Insert second-level tasks for Marketing Campaign (parent_id = 3)
INSERT INTO tasks (id, user_id, title, description, parent_id, depth, status_id, due_date) VALUES
  (18, 3, 'Social media schedule', 'Plan and schedule social posts', 3, 1, 4, '2025-03-20'),
  (19, 4, 'Email newsletter', 'Design and send monthly newsletters', 3, 1, 2, '2025-04-05');
